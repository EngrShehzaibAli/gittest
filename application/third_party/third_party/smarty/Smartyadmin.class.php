 ...
 */
if (!class_exists('Smartyadmin_Autoloader')) {
...
class Smarty extends Smarty_Internal_TemplateBase
{
    ...
    */
	...
	public function getmodule()
    {
		...
		global $RTR;
		return $this->_module = $RTR->fetch_module();
     ...
     * @return \Smarty current Smarty instance for chaining
     */
    public function setTemplateDirAdmin($template_dir, $isConfig = false)
    {
        if ($isConfig) {
    ...
    {
        return $this->setTemplateDirAdmin($config_dir, true);
    }
